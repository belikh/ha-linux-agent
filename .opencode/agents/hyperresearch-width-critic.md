...
description: "Use this agent in Layer 5 of the hyperresearch deep research pipeline. Reads the Layer 4 draft and returns a findings list of topics the width corpus supports but the draft doesn't cover. Spawn ONCE per draft, parallel with dialectic-critic and depth-critic."
mode: subagent
hidden: true
---
...
1. **Survey the vault.** Use
   `/home/io/projects/hyperresearch-opencode/.venv/bin/hyperresearch note list --tag <vault_tag> --all -j` to list every note.
