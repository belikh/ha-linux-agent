...
id: mqtt-home-assistant-3
tags:
- linux-agent-jupiteros-fleet-15537b
- near-duplicate
- stale-source
- known-issue
created: '2026-09-02T07:20:57.347165Z'
updated: '2026-09-02T07:26:15.330409Z'
source: https://www.home-assistant.io/docs/mqtt/birth_will/
source_domain: www.home-assistant.io
fetched_at: '2026-09-02T07:20:57.345337Z'
...
content_type: docs
deprecated: false
summary: 'DEPRECATED as duplicate: the legacy URL home-assistant.io/docs/mqtt/birth_will/
  (cited by HA community threads as THE birth/will reference) now HTTP-redirects to
  the main MQTT integration doc, which is already in the vault as mqtt-home-assistant
  (batch 1). Finding preserved: the standalone birth_will documentation page has been
  retired/merged into the integration doc — no dedicated HA doc for HA-client birth/will
  configuration exists anymore, which itself explains why community threads (2018-2025)
  keep struggling to find how to configure HA-side birth/will. The agent-side (device-side)
  availability pattern is documented in the integration doc under availability topics;
  HA-client-side birth/will is now an integration-UI setting.'
---

*Suggested by [[setting-mqtt-birth-and-last-will-with-the-new-mqtt-integration-configuration-hom]] — thread participants cite the official HA birth_will doc as the YAML-era reference for HA client birth/will config*
