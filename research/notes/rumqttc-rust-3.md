...
- rumqttc
- api-docs
created: '2026-09-02T13:17:47.988023Z'
updated: '2026-09-02T17:37:22.554985Z'
source: https://docs.rs/rumqttc/0.24.0/rumqttc/
source_domain: docs.rs
fetched_at: '2026-09-02T13:17:47.986906Z'
...
content_type: docs
deprecated: false
summary: 'docs.rs crate root for rumqttc EXACTLY 0.24.0 (the version pinned in this
  repo''s Cargo.lock; docs built 18 July 2025). Confirms: top-level API re-exports
  mqttbytes::v4::* (MQTT 3.1.1 is the default surface) with mqttbytes::v5 as a separate
  module — 0.24.0 is NOT v5-only. Documented reconnection model: ''Automatic reconnections
  by just continuing the eventloop.poll()/connection.iter() loop'' — automatic RECONNECTION,
  not re-subscription. Important notes: looping on poll()/iter() is mandatory to drive
  the event loop; blocking inside the loop blocks connection progress. Structs list
  includes MqttOptions, EventLoop, AsyncClient, Client, Connection; enums include
  Event {Incoming, Outgoing}. Deps: tokio ^1.36, flume ^0.11, rustls stack ^0.25/0.102.'
---
